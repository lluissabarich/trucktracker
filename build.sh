...
docker tag cloudantconsumer de.icr.io/trucktracker/cloudantconsumer:latest
docker push de.icr.io/trucktracker/cloudantconsumer:latest

cd ../redisConsumer
docker build -t redisconsumer .
docker tag redisconsumer de.icr.io/trucktracker/redisconsumer:latest
docker push de.icr.io/trucktracker/redisconsumer:latest

cd ../producer
docker build -t producer .
docker tag producer de.icr.io/trucktracker/producer:latest
docker push de.icr.io/trucktracker/producer:latest

cd ../web
docker build -t webserver .
docker tag webserver de.icr.io/trucktracker/webserver:latest
docker push de.icr.io/trucktracker/webserver:latest
cd ..
...
ibmcloud ce registry create --name contkey --server de.icr.io --password "${CONTKEY_PASS}"

#create a CE job for producers and consumers
ibmcloud ce job create --name cloudantconsumer --image de.icr.io/trucktracker/cloudantconsumer --cpu 0.125 --memory 0.25G --registry-secret contkey
ibmcloud ce jobrun submit --job cloudantconsumer --name cloudantconsumer

ibmcloud ce job create --name redisconsumer --image de.icr.io/trucktracker/redisconsumer --cpu 0.125 --memory 0.25G --registry-secret contkey
ibmcloud ce jobrun submit --job redisconsumer --name redisconsumer

ibmcloud ce job create --name producer --image de.icr.io/trucktracker/producer --cpu 0.125 --memory 0.25G --registry-secret contkey
...
ibmcloud ce application create --name webserver --image de.icr.io/trucktracker/webserver --cpu 0.125 --memory 0.25G --registry-secret contkey
